...
Ext.define('skin.view.tablet.Login', {
  ...
  config: {
    ...
    items: [
      {
        xtype: 'image',
        src: Ext.Viewport.getOrientation() == 'portrait' ? 'assets/templates/core/images/padlock_closed.png' : 'assets/templates/core/images/padlock_closed.png',
    ...
    listeners: {
      tap: {
            element: 'element',
            delegate: '#logInButtonTablet',
        fn: function(e) {
          console.log('Element with id "logInButtonTablet" was tapped!');
