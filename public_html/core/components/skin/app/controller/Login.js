...
Ext.define('skin.controller.Login', {
  ...
  onLogInCommand: function(view, reference, username, password) {
    ...
    Ext.Ajax.request({
      url: 'http://vanheemstrapictures.com/core/components/skin/api/services/login/', // make for real
      method: 'post',
  ...
  onLogOutCommand: function() {
    ...
    Ext.Ajax.request({
      url: 'http://vanheemstrapictures.com/core/components/skin/api/services/logout/', // make for real
      method: 'post',
      params: {
