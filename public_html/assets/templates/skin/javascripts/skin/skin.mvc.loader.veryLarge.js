function init()
{
	...
	appendText(mvcElement,'MVC: initialized for Very Large Client Width (>1440px).');
	appendStyles();
}
function appendStyles()
{
	...
	foundationStyle.href='assets/templates/skin/stylesheets/very-large/foundation.min.css';
}
