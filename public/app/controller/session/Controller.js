 ...
 */
Ext.define("Skin.controller.session.Controller", {
...
//        this.sessionService.setUsePromise(true);
    ...
    setSessionFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.session.Event", Skin.event.session.Event.SET_SESSION_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    clearSessionSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.session.Event", Skin.event.session.Event.CLEAR_SESSION_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    clearSessionFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.session.Event", Skin.event.session.Event.CLEAR_SESSION_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
     ...
     *
     * @param {Skin.event.session.Event} event Reference to the set session event. Contains the id and sessionId.
     */
     ...
     *
     * @param {Skin.event.session.Event} event Reference to the clear session event.
     */
