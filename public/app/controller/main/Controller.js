...
Ext.define("Skin.controller.main.Controller", {
    ...
    getMainListSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.GET_MAIN_LIST_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    getMainListFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.GET_MAIN_LIST_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    }, 
    ...
    getMainTileFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.GET_MAIN_TILE_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    }, 
    ...
    createMainSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.CREATE_MAIN_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    createMainFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.CREATE_MAIN_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    updateMainSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.UPDATE_MAIN_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    updateMainFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.UPDATE_MAIN_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    deleteMainSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.DELETE_MAIN_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    deleteMainFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.DELETE_MAIN_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
