 ...
 */
Ext.define("Skin.controller.ui.Controller", {
    ...
    /**
     * @event Skin.event.ui.Event.SET_SUCCESS
     * Fired when the ui service is successful.
     */

    /**
     * @event Skin.event.ui.Event.SET_FAILURE
    ...
    setupGlobalEventListeners: function() {
        ...
        this.eventBus.addGlobalEventListener(Skin.event.ui.Event.SET_UI, this.onSet, this);
    },
...
//        this.uiService.setUsePromise(true);
    ...
    setFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.ui.Event", Skin.event.ui.Event.SET_UI_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
     ...
     *
     * @param {Skin.event.ui.Event} event Reference to the set event. Contains the ui.
     */
