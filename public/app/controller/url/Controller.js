 ...
 */
Ext.define("Skin.controller.url.Controller", {
    ...
    /**
     * @event Skin.event.url.Event.SET_SUCCESS
     * Fired when the url service is successful.
     */

    /**
     * @event Skin.event.url.Event.SET_FAILURE
    ...
    setupGlobalEventListeners: function() {
        ...
        this.eventBus.addGlobalEventListener(Skin.event.url.Event.SET_URL, this.onSet, this);
    },
...
//        this.urlService.setUsePromise(true);
    ...
    setFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.url.Event", Skin.event.url.Event.SET_URL_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
     ...
     *
     * @param {Skin.event.url.Event} event Reference to the set event. Contains the url.
     */
