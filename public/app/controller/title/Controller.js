 ...
 */
Ext.define("Skin.controller.title.Controller", {
    ...
    /**
     * @event Skin.event.title.Event.SET_SUCCESS
     * Fired when the title service is successful.
     */

    /**
     * @event Skin.event.title.Event.SET_FAILURE
    ...
    setupGlobalEventListeners: function() {
        ...
        this.eventBus.addGlobalEventListener(Skin.event.title.Event.SET_TITLE, this.onSet, this);
    },
...
//        this.titleService.setUsePromise(true);
    ...
    setFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.title.Event", Skin.event.title.Event.SET_TITLE_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
     ...
     *
     * @param {Skin.event.title.Event} event Reference to the set event. Contains the title.
     */
