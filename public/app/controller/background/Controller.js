 ...
 */
Ext.define("Skin.controller.background.Controller", {
    ...
    /**
     * @event Skin.event.background.Event.SET_SUCCESS
     * Fired when the background service is successful.
     */

    /**
     * @event Skin.event.background.Event.SET_FAILURE
    ...
    setupGlobalEventListeners: function() {
        ...
        this.eventBus.addGlobalEventListener(Skin.event.background.Event.SET_BACKGROUND, this.onSet, this);
    },
...
//        this.backgroundService.setUsePromise(true);
     ...
     *
     * @param {Skin.event.background.Event} event Reference to the set event. Contains the background.
     */
