 ...
 */
Ext.define("Skin.controller.employee.Controller", {
...
//    },
    ...
    /**
     * @event Skin.event.employee.Event.GET_EMPLOYEE_LIST_SUCCESS
     * Fired when the get employee service is successful.
     */

    /**
     * @event Skin.event.authentication.Event.GET_EMPLOYEE_LIST_FAILURE
    ...
    setupGlobalEventListeners: function() {
        ...
        this.eventBus.addGlobalEventListener(Skin.event.employee.Event.GET_EMPLOYEE_LIST, this.onGetEmployeeList, this);
        this.eventBus.addGlobalEventListener(Skin.event.employee.Event.GET_EMPLOYEE_TILE, this.onGetEmployeeTile, this);
        this.eventBus.addGlobalEventListener(Skin.event.employee.Event.CREATE_EMPLOYEE, this.onCreateEmployee, this);
        this.eventBus.addGlobalEventListener(Skin.event.employee.Event.UPDATE_EMPLOYEE, this.onUpdateEmployee, this);
        this.eventBus.addGlobalEventListener(Skin.event.employee.Event.DELETE_EMPLOYEE, this.onDeleteEmployee, this);
    },
    ...
    getEmployeeListSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.GET_EMPLOYEE_LIST_SUCCESS);
    ...
    getEmployeeTileSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.GET_EMPLOYEE_TILE_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    getEmployeeListFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.GET_EMPLOYEE_LIST_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    getEmployeeTileFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.GET_EMPLOYEE_TILE_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    createEmployeeSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.CREATE_EMPLOYEE_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    createEmployeeFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.CREATE_EMPLOYEE_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    updateEmployeeSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.UPDATE_EMPLOYEE_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    updateEmployeeFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.UPDATE_EMPLOYEE_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    deleteEmployeeSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.DELETE_EMPLOYEE_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    deleteEmployeeFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.employee.Event", Skin.event.employee.Event.DELETE_EMPLOYEE_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
