 ...
 */
Ext.define("Skin.controller.authentication.Controller", {
    ...
    /**
     * @event Skin.event.authentication.Event.LOGIN_SUCCESS
     * Fired when the login service is successful.
     */

    /**
     * @event Skin.event.authentication.Event.LOGIN_FAILURE
     * Fired when the login service fails.
     */

    /**
     * @event Skin.event.authentication.Event.LOGOUT_SUCCESS
     * Fired when the logout service is successful.
     */

    /**
     * @event Skin.event.authentication.Event.LOGOUT_FAILURE
    ...
    setupGlobalEventListeners: function() {
        ...
        this.eventBus.addGlobalEventListener(Skin.event.authentication.Event.LOGIN, this.onLogin, this);
        this.eventBus.addGlobalEventListener(Skin.event.authentication.Event.LOGOUT, this.onLogout, this);
    },
...
//        this.authenticationService.setUsePromise(true);
    ...
    loginFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.authentication.Event", Skin.event.authentication.Event.LOGIN_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    logoutSuccess: function(response) {
        ...
        var evt = Ext.create("Skin.event.authentication.Event", Skin.event.authentication.Event.LOGOUT_SUCCESS);
        this.eventBus.dispatchGlobalEvent(evt);
    },
    ...
    logoutFailure: function(response) {
        ...
        var evt = Ext.create("Skin.event.authentication.Event", Skin.event.authentication.Event.LOGOUT_FAILURE);
        this.eventBus.dispatchGlobalEvent(evt);
    },
