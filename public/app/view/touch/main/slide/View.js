 ...
 * </p>
 */
Ext.define("Skin.view.touch.main.slide.View", {
    //extend: "Skin.view.touch.main.base.View",
	extend: "Ext.Container",
    alias: "widget.mainSlideView",
    controller: "Skin.mediator.touch.main.slide.Mediator",
     ...
     * @param {Skin.view.touch.main.slide.View} this The navigation View instance
	...
	initConfig: function() {
        ...
        me._indexCount = 0;
		// Set the groups.
		me.setGroups(Skin.config.global.Config.getGroups());
        // Create the store.
