 ...
 */
Ext.define("Skin.mediator.touch.main.slide.Mediator", {
...
//		},	
    ...
    getMainSlideData: function() {
        ...
        var evt = Ext.create("Skin.event.main.Event", Skin.event.main.Event.GET_MAIN_SLIDE);
    ...
    onLoginSuccess: function() {
		...
		if(Skin.config.global.Config.getNextView()==='mainslide') {
